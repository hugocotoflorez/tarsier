...
/* Interface */
char *sb_get(Sb s);                // return a string of the full screen
...
// return a string of the full screen
char *
sb_get(Sb s)
{
        return s.data;
...
// forget the first line and return !0. If there is only one line, return 0.
int
sb_drop_line(Sb *s)
{
        char *c;
